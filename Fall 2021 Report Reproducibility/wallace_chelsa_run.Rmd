...
d.occs <- 'H:/My Drive/HWC/R_files/R_output_data/occurrence_points'
...
userRas.paths <- file.path(d.envs, c('agg_cropped_CHELSA_bio01.tif','agg_cropped_CHELSA_bio02.tif', 'agg_cropped_CHELSA_bio05.tif', 'agg_cropped_CHELSA_bio06.tif', 'agg_cropped_CHELSA_bio12.tif', 'agg_cropped_CHELSA_bio13.tif', 'agg_cropped_CHELSA_bio14.tif'))
...
# save as raster
 # lion_historic_sdm <- writeRaster(pred, filename = file.path("H:/My Drive/HWC/Wallace SDM Rasters/lion_historic_sdm.tif"), overwrite = FALSE)
```
...
```{r}
# NOTE: provide the path to the folder that contains the rasters
d.envsFuture <- 'H:/My Drive/HWC/R_files/R_output_data/chelsa/future/2011_2040/SSP1_RCP26'

# create paths to the raster files
userRas.pathsFuture <- file.path(d.envsFuture, c('CHELSA_2011_2040_126_bio1.tif','CHELSA_2011_2040_126_bio2.tif', 'CHELSA_2011_2040_126_bio5.tif', 'CHELSA_2011_2040_126_bio6.tif', 'CHELSA_2011_2040_126_bio12.tif', 'CHELSA_2011_2040_126_bio13.tif', 'CHELSA_2011_2040_126_bio14.tif'))
...
```{r}
# rename future climate variable names (not necessary?)
names(predsProj) <- paste0('agg_cropped_CHELSA_bio', sprintf("%02d", c(1, 2, 5, 6, 12, 13, 14)))
...
# save as raster
 lion_historic_sdm <- writeRaster(proj, filename = file.path("H:/My Drive/HWC/Wallace SDM Rasters/lion_2071_2100_585_sdm.tif"), overwrite = FALSE)
```
