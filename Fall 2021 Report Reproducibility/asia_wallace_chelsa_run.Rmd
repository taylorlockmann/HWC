...
#plot(evalMods[["rm.0.5_fc.L"]], vars = c('asia_masked_CHELSA_layer1', 'asia_masked_CHELSA_layer2', 'asia_masked_CHELSA_layer7', 'asia_masked_CHELSA_layer10', 'asia_masked_CHELSA_layer11', 'asia_masked_CHELSA_layer12', 'asia_masked_CHELSA_layer16', 'asia_masked_CHELSA_layer17'), type = "cloglog")
...
*** We have decided to use the 0.5 LQ model beyond this point ***

********** 4/11/2022 double check the threshold function with Roshni below **********
```{r}
...
# thresh_10 <- function(modOccVals, type) {
#  # remove all NA
...
# save as raster
# asian_elephant_historic_10p_sdm <- writeRaster(pred_thr, filename = file.path("/Volumes/GoogleDrive/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/Wallace SDM Rasters/asia/1981_2010/asian_elephant_historic_20p_sdm.tif"), overwrite = FALSE)
```
...
```{r}
# NOTE: provide the path to the folder that contains the rasters
d.envsFuture <- '/Volumes/GoogleDrive/.shortcut-targets-by-id/1YB-Hz3L-kWyiZMg2UM89GQkvqXyZUW1H/HWC_data/R_files/R_output_data/chelsa_asia/2041_2070/585/GFDL_ESM4'

# create paths to the raster files
userRas.pathsFuture <- file.path(d.envsFuture, c('gfdl_2041_2070_585_bio1.tif','gfdl_2041_2070_585_bio2.tif', 'gfdl_2041_2070_585_bio4.tif', 'gfdl_2041_2070_585_bio6.tif', 'gfdl_2041_2070_585_bio7.tif', 'gfdl_2041_2070_585_bio12.tif', 'gfdl_2041_2070_585_bio14.tif', 'gfdl_2041_2070_585_bio15.tif'))
...
****** 4/12/2022 UPDATED TO THIS POINT!!! *******

***** 4/12/2022 *****
Something weird is happening in the codechunk below... perhaps something was updated and now isn't working?

Works in the asia_wallace_simple file, go back and update all code chunks above this one to match?
