...
afrotropical_region_sp <- st_read("H:/My Drive/HWC/R_files/R_output_data/afrotropical_region/afrotropical_region.shp")
...
occs$name <- "Panthera leo" #change depending on the species!
```
...
# write_csv(occs_wallace, "H:/My Drive/HWC/R_files/R_output_data/occurrence_points/lion_chelsa_points_thinned.csv")
```
