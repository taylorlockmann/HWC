...
rastlist <- list.files(path = "C:/Users/roshn/OneDrive/Desktop/emLab/hwc/data/wc2.1_2.5m_bio", pattern='.tif$', full.names=TRUE)
...
afrotropical_region <- read_sf(dsn = "C:/Users/roshn/OneDrive/Desktop/emLab/hwc/data/wwf_ecoregions/official", layer = "wwf_terr_ecos") %>% 
  filter(REALM == "AT")
...
for(i in bio){
        ...
        writeRaster(bioclim_crop[[i]], 
                    filename = paste0("C:/Users/roshn/OneDrive/Desktop/emLab/hwc/data/bioclim_v2/bio", i, ".asc"),
                    overwrite=TRUE)
}
```
...
land <- "C:/Users/roshn/OneDrive/Desktop/emLab/hwc/data/Globcover2009_V2.3_Global_/GLOBCOVER_L4_200901_200912_V2.3.tif"
land = raster(land)
