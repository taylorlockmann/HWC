...
# save occs to upload to Wallace if needed
      ...
      write_csv(occs_wallace, "H:/My Drive/HWC/R_files/R_output_data/occurrence_points/sav_elephant_chelsa_points_thinned.csv")
```
...
#get csv for wallace (wrong format?)
# write_csv(afrotropical_region, "H:/My Drive/HWC/R_files/R_output_data/afrotropical_region/afrotropical_region.csv")

#put geometry into longitude and latitude columns for wallace
afrotropical_region_lat_lon <- tidyr::extract(afrotropical_region, geometry, into = c('latitude', 'longitude'), '\\((.*),(.*)\\)', conv = T)

#remove all columns except lat, lon, and geometry
afrotropical_region_lat_lon_sub <- afrotropical_region_lat_lon[, -c(1:22, 25)]

# get csv for wallace
# write_csv(afrotropical_region_lat_lon_sub, "H:/My Drive/HWC/R_files/R_output_data/afrotropical_region/afrotropical_region_lat_lon_sub.csv")
...
bioclim_crop_4326 <- projectRaster(bioclim_crop,
                                       crs = 4326)
