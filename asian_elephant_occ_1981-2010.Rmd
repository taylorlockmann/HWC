---
title: "Asian Elephant Occurrence Data 1981-2010"
...
all_spp_coords <- rbind(indicus_coords, maximus_coords)
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 1", title = "Mean Annual Air Temp 1981-2010") +
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 2", title = "Mean Diurnal Air Temp Range 1981-2010") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5))
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 5", title = "Mean Daily Max Air Temp of Warmest Month 1981-2010") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5))
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 6", title = "Mean Daily Min Air Temp of Coldest Month 1981-2010") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5))
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 12", title = "Annual Precip 1981-2010") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5))
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 13", title = "Precip Amount of the Wettest Month 1981-2010") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5))
```
...
ggplot() +
  ...
  theme_minimal() +
  labs(x = "Species", y = "CHELSA 14", title = "Precip Amount of the Driest Month 1981-2010") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5))
```
